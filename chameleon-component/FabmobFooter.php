...
class FabmobFooter extends Component {
		...
		$ret = '
			...
			<div class="row">
				<div class="col-md-3 col-sm-6 col-xs-6">
					<img src="'. $wgScriptPath . '/images/fabmob/logo_fabmob.png" width="200" class="logo-fabmob">
				</div>
				<div class="col-md-3 col-sm-6 col-xs-6">
					<h4>'. wfMessage( 'fmfootertitle-about' )->text() .'</h4>
					<ul class="list-unstyled">
						<li><a href="/wiki/Proposition_de_valeur_pour_une_startup">'. wfMessage( 'fmfooter-startup' )->text() .'</a></li>
						<li><a href="/wiki/Proposition_de_valeur_pour_un_industriel">Industriel</a></li>
						<li><a href="/wiki/Communaut%C3%A9s">'. wfMessage( 'fmfooter-communaute' )->text() .'</a></li>
				...
				<div class="col-md-3 col-sm-6 col-xs-6">
					...
					<ul class="list-unstyled">
						<li><a href="/wiki/'. wfMessage( 'fmfooterlinks-recentchanges' )->text() .'">'. wfMessage( 'fmfooter-recentchanges' )->text() .'</a></li>
						<li><a href="/wiki/'. wfMessage( 'fmfooterlinks-users' )->text() .'">'. wfMessage( 'fmfooter-users' )->text() .'</a></li>
						<li><a href="/wiki/'. wfMessage( 'fmfooterlinks-tools' )->text() .'">'. wfMessage( 'fmfooter-tools' )->text() .'</a></li>
				...
				<div class="col-md-3 col-sm-6 col-xs-6">
					...
					<ul class="list-unstyled">
						...
						<li><a href="'. wfMessage( 'fmfooterlinks-emploi' )->text() .'">'. wfMessage( 'fmfooter-emploi' )->text() .'</a></li>
					</ul>
				</div>
			</div>
			</div>
	...
	public static function getConnectionRequiredModal() {
		...
		$ret = '
				...
				<h4 class="modal-title" id="myModalLabel">'.wfMessage('userlogin')->text().'</h4>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				</div>
				<div class="modal-body">
				'.wfMessage('loginrequired')->text().'
				</div>
				<div class="modal-footer">
				<a href="'.$createAccountUrl.'"><button type="button" class="btn btn-default">'.wfMessage('nologin')->text().'</button></a>
				<a href="'.$loginUrl.'"><button type="button" class="btn btn-primary">'.wfMessage('gotaccount')->text().'</button></a>
				</div>
				</div>
				</div>
				</div>';
